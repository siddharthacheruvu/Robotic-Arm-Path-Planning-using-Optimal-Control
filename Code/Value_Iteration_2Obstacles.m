...
%     q1d(end+1) = (abs(qout(i+1,1))-abs(qout(i,1)))/dt;
%     q2d(end+1) = (abs(qout(i+1,2))-abs(qout(i,2)))/dt;
%     q1dd(end+1) = (q1d(i+1)-q1d(i))/dt;
%     q2dd(end+1) = (q2d(i+1)-q2d(i))/dt;
% end
% 
% figure;
% subplot(3,1,1);
% plot(1:size(qout,1),qout(:,1),'Linewidth',2);hold on;
% plot(1:size(qout,1),qout(:,2),'Linewidth',2);
% xlabel('Time Step')
% ylabel('Joint Angles')
% legend('q1','q2');
% 
% subplot(3,1,2);
% plot(1:size(qout,1),q1d,'Linewidth',2);hold on;
% plot(1:size(qout,1),q2d,'Linewidth',2);
% xlabel('Time Step')
% ylabel('Joint Velocities')
% legend('q1d','q2d');
% 
% subplot(3,1,3);
% plot(1:size(qout,1),q1dd,'Linewidth',2);hold on;
% plot(1:size(qout,1),q2dd,'Linewidth',2);
% xlabel('Time Step')
